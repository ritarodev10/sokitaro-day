...
export default function BrideArticle() {
  return (
    <div
      className="relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            A Gentle Light Who Chose with Clarity and Grace
          </p>
        </div>
        ...
        >
          ...
          <div className="flex flex-col justify-start">
            ...
            >
              Daughter of Mr. Supiyoko & Mrs. Mulyati.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Soft-hearted, warm, and quietly radiant, Sukma carries the kind of
              kindness that settles any room she walks into. She is thoughtful,
              grounded, and beloved for her sincerity and gentle strength.
            </p>
            <p
              style={{
                marginBottom: "clamp(0.5rem, 1.5vh, 0.75rem)",
            ...
            >
              Life did not always follow a straight line, nor did clarity always
              arrive early. But when the moment finally came, she chose with a
              steady heart, recognizing the sincerity that had waited for her all
              along.
            </p>
            <p
              style={{
            ...
            >
              The journey was long, the timing unexpected, and the paths sometimes
              winding. Yet every step, every pause, and every prayer ultimately
              led her back to the person who had admired her since the beginning,
              and this time, she met him not as a distant memory, but as the
              future she was ready to embrace.
            </p>
          </div>
        </div>
      </div>
