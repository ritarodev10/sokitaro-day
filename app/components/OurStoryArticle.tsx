...
export default function OurStoryArticle() {
  return (
    <div
      className="relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            The presses are warming up — our story is almost ready for print.
          </p>
        </div>
        ...
        >
          ...
          >
            OUR STORY — CURRENTLY BEING PRINTED
          </h2>
        </div>
        ...
        >
          ...
          >
            ...
            >
              The Sokitaro Post editorial team is still assembling this special
              feature. A few key moments are being typeset and aligned before we
              roll the final print.
            </p>
            <p
              style={{
            ...
            >
              Please check again shortly. The pressmen are working overtime.
            </p>
          </div>
        </div>
      </div>
